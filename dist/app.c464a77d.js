...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.wickedTec1=void 0;var e=require("lit-html"),i=require("../util"),t=s(require("../assets/TEC-1.jpg"));function s(e){return e&&e.__esModule?e:{default:e}}const n={Digit0:0,Digit1:1,Digit2:2,Digit3:3,Digit4:4,Digit5:5,Digit6:6,Digit7:7,Digit8:8,Digit9:9,KeyA:10,KeyB:11,KeyC:12,KeyD:13,KeyE:14,KeyF:15,Space:19,Tab:19,Enter:18,Minus:17,ArrowDown:17,ArrowUp:16},d=(0,i.withProps)({init:function(e){this.digits=0,this.segments=0,this.display=Array(6).fill(0),this.handleVisibility=this.handleVisibility.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)},onconnected(e){this.worker=new Worker("worker.0b859836.js"),this.worker.onmessage=(e=>{let i=new Uint8Array(e.data.buffer);this.digits=i[1],this.segments=i[2],this.requestRender(),this.display=[...new Uint8Array(e.data.display)]}),this.worker.postMessage({type:"INIT"}),document.addEventListener("keydown",this.handleKeyDown),(0,i.addVisibilityListener)(this.handleVisibility)},ondisconnected(e){this.worker.terminate(),document.removeEventListener("keydown",this.handleKeyDown),(0,i.removeVisiblityListener)(this.handleVisibility)},handleVisibility(){this.worker.postMessage({type:"HIDDEN",value:(0,i.isHidden)()})},handleKeyDown(e){this.handleButton(e.code,e.shiftKey,e.ctrlKey)?e.preventDefault():console.log(e,e.code,e.key)},handleButton(e,i,t){if("Escape"===e)return this.worker.postMessage({type:"RESET"}),!0;if("Space"===e)return this.worker.postMessage({type:"PAUSE"}),!0;if(e in n){let t=n[e];return i&&(t|=128),this.worker.postMessage({type:"SET_INPUT_VALUE",port:0,value:t}),this.worker.postMessage({type:"NMI"}),!0}},render({digits:i,segments:s,display:n}){return e.html`
<div>digits ${i} segments ${s}</div>
<style>
    #tec1 {
        width: 600px;
        height: 375px;
...
<div id="tec1">
    ...
    <div is="keypad-modern" @click=${e=>this.handleButton(e.detail.code)}></div>
...
`}});exports.wickedTec1=d;
},{"lit-html":"KMqM","../util":"WLd9","../assets/TEC-1.jpg":"QWBP","./../worker/worker.js":[["worker.0b859836.js","nnuQ"],"worker.0b859836.map","nnuQ"]}],"6Rl6":[function(require,module,exports) {
...
},{"wicked-elements":"8+Lu","./components/wicked-tec1":"tH/w","./components/seven-seg-display":"6Rl6","./components/seven-seg":"Y3is","./components/instructions":"K4QV","./components/key-button":"MzdT","./components/keypad-classic":"NlCz","./components/keypad-modern":"Lu1m"}],"Bh1I":[function(require,module,exports) {
...
//# sourceMappingURL=app.1c722281.map