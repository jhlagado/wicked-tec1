...
"use strict";let e,t;Object.defineProperty(exports,"__esModule",{value:!0}),exports.audioValue=o,exports.isAudioPlaying=i,exports.audioInit=r,exports.audioPlay=s,exports.audioToggle=a;let u=!1;function n(){e=new AudioContext,t&&t.stop(),(t=e.createOscillator()).type="square",t.frequency.setValueAtTime(440,e.currentTime),t.connect(e.destination),t.start()}function o(n){null!=n&&u&&t.frequency.setValueAtTime(n,e.currentTime)}function i(){return u}function r(){e||n(),u=!0}function s(t){e||n(),u!==t&&(u?(e.suspend(),u=!1):(e.resume(),u=!0))}function a(){u?audioPause():s()}
},{}],"tH/w":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.wickedTec1=void 0;var e=require("lit-html"),i=require("../util"),t=n(require("../assets/TEC-1.jpg")),s=require("../util/audio");function n(e){return e&&e.__esModule?e:{default:e}}const d={Digit0:0,Digit1:1,Digit2:2,Digit3:3,Digit4:4,Digit5:5,Digit6:6,Digit7:7,Digit8:8,Digit9:9,KeyA:10,KeyB:11,KeyC:12,KeyD:13,KeyE:14,KeyF:15,Space:19,Tab:19,Enter:18,Minus:17,ArrowDown:17,ArrowUp:16},o=(0,i.withProps)({init:function(e){this.digits=0,this.segments=0,this.display=Array(6).fill(0),this.handleVisibility=this.handleVisibility.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this),this.classic="true"===localStorage.getItem("classic")},onconnected(e){this.worker=new Worker("worker.4fd36a23.js"),this.worker.onmessage=(e=>{let i=new Uint8Array(e.data.buffer);this.digits=i[1],this.segments=i[2],this.requestRender(),this.display=[...new Uint8Array(e.data.display)],this.wavelength=e.data.wavelength,this.frequency=this.wavelength?5e5/this.wavelength:0,(0,s.audioValue)(this.frequency)}),this.worker.postMessage({type:"INIT"}),document.addEventListener("keydown",this.handleKeyDown),(0,i.addVisibilityListener)(this.handleVisibility)},ondisconnected(e){this.worker.terminate(),document.removeEventListener("keydown",this.handleKeyDown),(0,i.removeVisiblityListener)(this.handleVisibility)},handleVisibility(){this.audioPlay((0,i.isHidden)()),this.worker.postMessage({type:"HIDDEN",value:(0,i.isHidden)()})},handleKeyDown(e){this.handleButton(e.code,e.shiftKey,e.ctrlKey)?e.preventDefault():console.log(e,e.code,e.key)},handleButton(e,i,t){if((0,s.audioInit)(),"Escape"===e)return this.worker.postMessage({type:"RESET"}),!0;if("Space"===e)return this.worker.postMessage({type:"PAUSE"}),!0;if(e in d){let t=d[e];return i&&(t|=128),this.worker.postMessage({type:"SET_INPUT_VALUE",port:0,value:t}),this.worker.postMessage({type:"NMI"}),!0}},toggleAudio(){(0,s.audioToggle)(),this.worker.postMessage({type:s.isAudioPlaying?"AUDIO_PLAY":"AUDIO_PAUSE"})},render({digits:i,segments:s,display:n,wavelength:d,frequency:o}){return e.html`
<style>
    body {
...
<div id="tec1">
    ...
    <div id="digitPane">
        <div id="seven" is="seven-seg-display" .digits=${i} .segments=${s} .display=${n}></div>
    </div>
</div>
<div>classic keyboard <input type="checkbox"
    ?checked=${this.classic}
    @change=${e=>{this.classic=e.target.checked,localStorage.setItem("classic",String(this.classic))}}></div>
<div is="instructions" style="margin-left: 35px"></div>
`}});exports.wickedTec1=o;
},{"lit-html":"KMqM","../util":"WLd9","../assets/TEC-1.jpg":"QWBP","../util/audio":"P4dJ","./../worker/worker.js":[["worker.4fd36a23.js","nnuQ"],"worker.4fd36a23.map","nnuQ"]}],"6Rl6":[function(require,module,exports) {
...
//# sourceMappingURL=src.c153ad25.map