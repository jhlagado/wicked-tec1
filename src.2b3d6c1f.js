...
<div style="display:inline-block">
    <div style="display:flex; justify-content:space-between; align-items: center; margin: 3px">
        <div>
            HEX
            <input type="file" accept=".hex" @change=${e=>this.handleUpload(e)}>
        </div>
        <div>
            ROM
            <select @change=${e=>this.handleChangeROM(e.target.value)}>
                <option>MON-1</option>
...
},{"lit-html":"KMqM","../util":"WLd9","../assets/TEC-1.jpg":"QWBP","../util/audio":"P4dJ","./../worker/worker.js":[["worker.679e6af4.js","nnuQ"],"worker.b53bffb2.map","nnuQ"],"_bundle_loader":"z1Am","../roms/MON-1A":[["src.2b3d6c1f.js","H99C"],"src.736a9b18.map",["TEC-1.c2019513.jpg","QWBP"],"ZoHI"],"../roms/MON-1B":[["MON-1B.df7c737a.js","/15E"],"MON-1B.df7c737a.map","/15E"],"../roms/MON-2":[["MON-2.833df39e.js","8zL2"],"MON-2.833df39e.map","8zL2"],"../roms/MON-1":[["MON-1.69b81ee1.js","hmvP"],"MON-1.69b81ee1.map","hmvP"]}],"6Rl6":[function(require,module,exports) {
...
//# sourceMappingURL=src.736a9b18.map